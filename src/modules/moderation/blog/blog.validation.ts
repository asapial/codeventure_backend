...
export type IListBlogQuery = z.infer<typeof listBlogQuerySchema>;

export const decideBlogBodySchema = z.object({
...
export type IDecideBlogBody = z.infer<typeof decideBlogBodySchema>;